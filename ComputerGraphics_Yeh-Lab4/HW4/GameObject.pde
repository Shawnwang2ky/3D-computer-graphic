public class GameObject {
    ...
    Matrix4 localToWorld() {
        ...
        // 旋轉矩陣 (順序為 Z * Y * X)
        Matrix4 rotXMatrix = Matrix4.RotX(rotation.x);
        Matrix4 rotYMatrix = Matrix4.RotY(rotation.y);
        Matrix4 rotZMatrix = Matrix4.RotZ(rotation.z);
        Matrix4 rotationMatrix = rotZMatrix.mult(rotYMatrix).mult(rotXMatrix);

        // 平移矩陣
        Matrix4 translationMatrix = Matrix4.Trans(translation);
