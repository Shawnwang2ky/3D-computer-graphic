static public class Matrix4{
  ...
  void makeRotX(float a) {
      ...
      // 設置 X 軸旋轉矩陣
      m[0] = 1.0f;  m[1] = 0.0f;  m[2] = 0.0f;  m[3] = 0.0f;
      m[4] = 0.0f;  m[5] = cosA;  m[6] = -sinA; m[7] = 0.0f;
      m[8] = 0.0f;  m[9] = sinA;  m[10] = cosA; m[11] = 0.0f;
      m[12] = 0.0f; m[13] = 0.0f; m[14] = 0.0f; m[15] = 1.0f;
  }
  ...
  void makeRotY(float a) {
      ...
      // 設置 Y 軸旋轉矩陣
      m[0] = cosA;  m[1] = 0.0f;  m[2] = sinA;  m[3] = 0.0f;
      m[4] = 0.0f;  m[5] = 1.0f;  m[6] = 0.0f;  m[7] = 0.0f;
      m[8] = -sinA; m[9] = 0.0f;  m[10] = cosA; m[11] = 0.0f;
      m[12] = 0.0f; m[13] = 0.0f; m[14] = 0.0f; m[15] = 1.0f;
  }
  void makeRotZ(float a) {
    ...
    // 設置 Z 軸旋轉的矩陣
    m[0] = cosA;  m[1] = -sinA; m[2] = 0.0f;  m[3] = 0.0f;
    m[4] = sinA;  m[5] = cosA;  m[6] = 0.0f;  m[7] = 0.0f;
    m[8] = 0.0f;  m[9] = 0.0f;  m[10] = 1.0f; m[11] = 0.0f;
    m[12] = 0.0f; m[13] = 0.0f; m[14] = 0.0f; m[15] = 1.0f;
  }
